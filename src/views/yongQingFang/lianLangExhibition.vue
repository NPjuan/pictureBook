  ...
  export default {
    ...
    data() {
      return {
        ...
        gallery: [
          {
            src: require('../../assets/images/lianLang/lianLang_0.png')
          },
          {
            src: require('../../assets/images/lianLang/lianLang_1.png')
          },
          {
            src: require('../../assets/images/lianLang/lianLang_2.png')
          },
          {
            src: require('../../assets/images/lianLang/lianLang_3.png')
          }
        ],
        imgSrc: require('../../assets/images/lianLang/lianLang_0.png')
      }
    },
    methods: {
